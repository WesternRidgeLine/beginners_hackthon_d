...
def extract_tag(text_or_url):
  ...
  reccomend_tag_list = [pair[0] for pair in ma_parse(input_text)[:100]][:10]
...
if __name__ == '__main__':
  ...
  extract_tag_chatgpt("https://note.nkmk.me/python-re-match-search-findall-etc/", ["物理学", "数学", "正規表現"])
  ...
  extract_tag("https://note.nkmk.me/python-re-match-search-findall-etc/")
